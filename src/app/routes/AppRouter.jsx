...
// --- My 내부 섹션 ---
const UserInfoSection = lazy(() => import('@widgets/my-page/UserInfoSection/UserInfoSection'));
const MyList = lazy(() => import('@widgets/my-page/MyListSection/MyListSection'));
const MyListDetail = lazy(() => import('@widgets/my-page/MyListDetail/MyListDetail'));
const MyReview = lazy(() => import('@widgets/my-page/MyReview/MyReview'));
