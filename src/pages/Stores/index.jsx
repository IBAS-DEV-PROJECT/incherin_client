  ...
  return (
    <StyledStoresContainer>
      <StyledHeader>
        <StyledTopRow>
          ...
          <StyledDropdownWrapper>
            <StoreDropdown options={FILTER_OPTIONS} placeholder="정렬 선택" />
          </StyledDropdownWrapper>
      ...
      {displayedStores.length === 0 ? (
        <StyledEmptyMessage>조건에 맞는 가게가 없습니다.</StyledEmptyMessage>
      ) : (
        <>
          <StyledStoreGrid>
          ...
          {/* 무한 스크롤 트리거 */}
          {hasMore && <StyledLoadMoreTrigger ref={targetRef} />}
